...
const HEIGHT_CODE_EDITOR = 360;
const MIN_HEIGHT_CODE_EDITOR = 132;
const MAX_HEIGHT_CODE_EDITOR = 700;
const HEIGHT_COMP_EDITOR = `calc(80vh - ${MIN_HEIGHT_CODE_EDITOR - 10}px)`;
